...
const logoSrc = computed(function () {
  if (appStore.theme === 'dark')
    return '/pwa-dark-192x192.png'
  return '/logo.svg'
})

const logoNameSrc = computed(function () {
  if (appStore.theme === 'dark')
...
<template>
  <div class="flex items-center justify-between">
    ...
    <NButton strong secondary @click="handleAdd()"
        style="padding: 24px 12px; border-radius: 12px; width: 130px;">
      <template #icon>
